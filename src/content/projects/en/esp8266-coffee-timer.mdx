...
This project followed my ["Bean it" project](/en/projects/bean-it/).
...
Born was the project idea to take the vibration activated timer of the ["Bean it" app](/en/projects/bean-it/) and to put that into a small, dedicated device.
